...
public class CetakKRSAdmin extends JFrame {
    ...
    public CetakKRSAdmin() {
        initComponents();
        loadData();
    }

    private void initComponents() {
        setTitle("Cetak Semua KRS - Admin");
        ...
        JPanel headerPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(0, 0, new Color(0, 120, 120), getWidth(), 0, new Color(0, 153, 153));
        ...
        JLabel logoText = new JLabel("Cetak Semua Data KRS");
        logoText.setFont(FONT_BOLD_20);
        logoText.setForeground(Color.WHITE);
        logoArea.add(logoText);

        JPanel btnArea = new JPanel(new FlowLayout(FlowLayout.RIGHT, 16, 0));
        btnArea.setOpaque(false);

        RoundedButton backBtn = new RoundedButton("Dashboard", 25);
        ...
        headerPanel.add(logoArea, BorderLayout.WEST);
        headerPanel.add(btnArea, BorderLayout.EAST);
        ...
        JLabel title = new JLabel("Rekap Seluruh Data KRS Mahasiswa");
        title.setFont(FONT_BOLD_18);
        title.setForeground(new Color(0, 120, 120));
    ...
    private void cetakPDF() {
        ...
        fileChooser.setDialogTitle("Simpan Rekap Seluruh KRS");
        fileChooser.setSelectedFile(new File("Rekap_Seluruh_KRS_Mahasiswa.pdf"));
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            boolean success = PDFGenerator.generateRekapKRSAll(path);
            if (success) {
